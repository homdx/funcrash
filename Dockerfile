...
RUN date && cd /home/user/.buildozer/android/platform && time wget --quiet https://dl.google.com/android/repository/android-ndk-r17c-linux-x86_64.zip && unzip android-ndk-r17c-linux-x86_64.zip && rm android-ndk-r17c-linux-x86_64.zip && date
