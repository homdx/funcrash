...
RUN  cd ~/.buildozer/android/platform \
&& tar -xf android-sdk_r24-linux.tgz android-sdk-linux/tools \
&& rm -rf android-sdk-24/tools \
&& mv android-sdk-linux/tools android-sdk-24 \
&& rm -rf android-sdk-linux \
&& cd ${WORK_DIR}\app2 && cp -vf buildozer-python31.spec buildozer.spec \
